        ...
        >
          ...
          <div className="relative z-[2] mx-auto max-w-[720px]">
            ...
            <p className="mx-auto mt-5 max-w-[560px] text-lg leading-[1.6] text-white/[0.88]">
              Una conversación de 45 minutos puede cambiar el rumbo de tu negocio. Sin compromisos,
              sin tecnicismos. Análisis gratuito, propuesta personalizada y estimado claro.
            </p>
            <div className="mt-9">
              <a
                href={WA_DEFAULT}
