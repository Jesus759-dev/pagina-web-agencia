    ...
    >
      ...
      <AnimatePresence>
        {hovered && (
          <motion.span
            ...
            className="mr-3 whitespace-nowrap rounded-lg border border-line bg-white px-3 py-1.5 text-sm font-medium text-ink shadow-lg"
            role="tooltip"
            id="whatsapp-tooltip"
          >
            Chatea con nosotros
      ...
      <a
        ...
        style={{
          ...
          boxShadow: "0 0 20px rgba(37, 211, 102, 0.4), 0 6px 16px rgba(15,23,42,0.18)",
        }}
      >
        {/* Pulse ring */}
        <span
